...
public class ResourceKeyPatternController extends BaseController<ResourceKeyPattern, String, ResourceKeyPatternDTO> {
	...
	@Override
	protected String getId(ResourceKeyPattern t) {
		return t.getId();
	}
