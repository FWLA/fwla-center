...
public class MasterLayerService extends CompositeLayerService {
	...
	public MasterLayerService(OperationRepository operationRepository, StationRepository stationRepository,
			RealEstateRepository realEstateRepository) {
		super(new SystemLayerService(operationRepository, stationRepository, realEstateRepository));
	}
}
